...
/// </summary>
internal static class JobspectArchitecture
{
    internal const string SharedKernelAssembly = "Jobspect.SharedKernel";
    internal const string InfrastructureAssembly = "Jobspect.Infrastructure";

    internal const string ApiAssembly = "Jobspect.Api";
    internal const string WorkerAssembly = "Jobspect.Worker";
    internal const string MigrationServiceAssembly = "Jobspect.MigrationService";
    ...
    /// by the <c>Jobspect.Modules</c> namespace, which becomes visible here once
    ...
    internal static string ImplementationOf(string module) => $"Jobspect.Modules.{module}";

    internal static string ContractsOf(string module) => $"Jobspect.Modules.{module}.Contracts";
