...
- **Status:** Accepted
- **Date:** 2026-07-29
- **Amended:** 2026-07-30 — the timestamp guard is per fact group, not per row; monotone facts need no guard; the funnel needs its own columns. See *Revision history*.
